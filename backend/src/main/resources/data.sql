...
VALUES (1, 'Lufuno', 'Nemudzivhadi', 'lufuno@example.com', 'password123', '1990-05-10');

INSERT INTO investors (id, firstname, lastname, email, password, date_of_birth)
VALUES (2, 'Sarah', 'Nkosi', 'sarah@example.com', 'password123', '1955-03-22');

-- Investment Products
INSERT INTO investment_products (id, product_name, product_type, balance, investor_id)
